...
|---|---|---|---|---|---|---|---|
| P0 | Design tokens + brand shell | active | standard | - | `phases/P0-design-tokens-brand-shell.md` | shared CSS tokens + masthead (logo, palette, type) exist; no screen content restyled yet | browser-verified: page loads with new palette/logo, all three sections still function |
...
Exactly one phase is `active` at a time. Start with P0 once this plan is confirmed.
